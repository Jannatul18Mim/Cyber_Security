...
[Click here to view Linux File Hierarchy Structure](https://media.geeksforgeeks.org/wp-content/uploads/20260108164511372024/Linux_File_Hierarchy_Structure.png)
...
১. Console (The Physical Interface)
    ...
    কি: এটি সরাসরি কম্পিউটারের সাথে যুক্ত একটি ফিজিক্যাল ডিভাইস। প্রাচীনকালে এটি ছিল একটি মনিটর এবং কিবোর্ড যা দিয়ে সরাসরি মেইনফ্রেম কম্পিউটার কন্ট্রোল করা হতো।
